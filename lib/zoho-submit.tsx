...
export async function submitToZoho(mergedData: any) {
  console.log("Preparing data for Zoho submission from function...");
  ...
  try {
    ...
    const zohoData = {
      ...
      Date: mergedData.date
        ? new Date(mergedData.date).toISOString().split("T")[0]
        : null,
      ...
      Meeting_After_Exhibition: mergedData.meetingAfterExhibition
        ? "Yes"
        : "No",
      ...
      Company: mergedData.companyName || null,
      Mobile: mergedData.contactNumbers
        ? mergedData.contactNumbers.split(",")[0]
        : null,
      Mobile_2: mergedData.contactNumbers
        ? mergedData.contactNumbers.split(",")[1]
        : null,
      Phone: mergedData.contactNumbers
        ? mergedData.contactNumbers.split(",")[2]
        : null,
