...
// import { Input } from "@/components/ui/input"
// import { Button } from "@/components/ui/button"
// import { Eye, Trash, MoreHorizontal, Edit, ZoomIn, Download, Loader2 } from "lucide-react"
...
//   // Memoize fetchForms to prevent it from being recreated on every render
...
//           toast({
//             title: "Limit Reached",
//             description: errorData.message || "Form submission limit reached. Please upgrade your plan.",
//             variant: "destructive",
//           })
//           setForms([])
//           extractUniqueUsers([])
...
//   useEffect(() => {
//     fetchForms()
//   }, [fetchForms]) // Depend on the memoized fetchForms
...
//   // Memoize handleUpdate to prevent it from being recreated on every render
//   const handleUpdate = useCallback(
//     async (updatedData: any, formId: string, closeDialog: () => void) => {
//       const submissionData = {
//         ...updatedData,
...
//       }
//     },
//     [toast, fetchForms], // Include fetchForms in the dependency array
//   )

//   // Memoize handleExtractedDataUpdate to prevent it from being recreated on every render
//   const handleExtractedDataUpdate = useCallback(
//     async (updatedData: any, formId: string, closeDialog: () => void) => {
//       try {
//         const res = await fetch(`/api/forms/${encodeURIComponent(formId)}`, {
...
//     const hasChanges = useMemo(() => JSON.stringify(formData) !== JSON.stringify(initialData.current), [formData])
...
//             </label>
//             <Input
//               value={formData[key as keyof typeof formData] ?? (value as string) ?? ""}
//               onChange={(e) => handleChange(key, e.target.value)}
//               className="w-full"
//               disabled={disabledFields.includes(key)}
//             />
...
//           <div className="flex gap-2 mb-4">
//             <Button
//               className={view === "raw" ? "bg-[#62588b] hover:bg-[#31294e] text-white" : ""}
//               variant={view === "raw" ? "default" : "outline"}
//               onClick={() => setView("raw")}
//             >
//               Raw Data
//             </Button>
//             <Button
//               className={view === "table" ? "bg-[#62588b] hover:bg-[#31294e] text-white" : ""}
//               variant={view === "table" ? "default" : "outline"}
//               onClick={() => setView("table")}
//             >
//               Table Data
...
//           {view === "raw" ? (
//             <ScrollArea className="h-[calc(90vh-200px)] bg-muted p-4 rounded-md">
//               <pre className="text-sm whitespace-pre-wrap">{formatData(data)}</pre>
//             </ScrollArea>
//           ) : (
//             <ScrollArea className="h-[calc(90vh-200px)]">
//               <table className="w-full text-sm border-collapse">
...
//                 <tbody>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words font-medium">Card Image</td>
//                     <td className="py-1 px-2 border w-1/2">
//                       {data.cardFrontPhoto ? (
//                         <button onClick={() => setZoomedImage(data.cardFrontPhoto!)} className="group relative block">
//                           <img
...
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Card No</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">{data.cardNo ?? "N/A"}</td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Sales Person</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       {data.salesPerson ?? "N/A"}
//                     </td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Date</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       {data.date ? new Date(data.date).toLocaleDateString() : "N/A"}
//                     </td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">User</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       {data.user?.email || "N/A"}
//                     </td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Company</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       <div className="font-medium">{mergedData?.companyName || "N/A"}</div>
//                       <div className="text-[10px] text-muted-foreground">{mergedData?.name || "No contact"}</div>
//                     </td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Contact Info</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       {mergedData?.email && <div>{mergedData.email}</div>}
//                       {mergedData?.contactNumbers && (
//                         <div className="text-[10px] text-muted-foreground">
...
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Lead Status</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">{data.leadStatus ?? "N/A"}</td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Deal Status</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">{data.dealStatus ?? "N/A"}</td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Meeting</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       {data.meetingAfterExhibition ? "Yes" : "No"}
//                     </td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Form Status</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">{data.status ?? "N/A"}</td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Extraction Status</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">
//                       {data.extractionStatus ?? "N/A"}
//                     </td>
//                   </tr>
//                   <tr>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">Zoho Status</td>
//                     <td className="py-1 px-2 border w-1/2 whitespace-normal break-words">{data.zohoStatus ?? "N/A"}</td>
//                   </tr>
//                 </tbody>
//               </table>
//             </ScrollArea>
...
//   const selectedViewForm = openView ? forms.find((f) => f.id === openView) : null
//   const selectedEditForm = openEdit ? forms.find((f) => f.id === openEdit) : null
...
//                     <thead className="sticky top-0 z-10">
//                       <tr>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Card Image</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Card No</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-28">Sales Person</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Date</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-40">User</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-32">Company</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-32">Contact Info</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Lead Status</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Deal Status</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-20">Meeting</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Form Status</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-32">Extraction Status</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Zoho Status</th>
//                         <th className="bg-gray-100 py-2 px-2 border w-24">Actions</th>
//                       </tr>
//                     </thead>
//                     <tbody>
//                       {currentItems.length > 0 ? (
...
//                                 <td className="py-1 px-2 border">
//                                   {form.cardFrontPhoto ? (
//                                     <button onClick={() => setZoomedImage(form.cardFrontPhoto!)} className="group">
//                                       <img
...
//                                 <td className="py-1 px-2 border">
//                                   <div className="truncate font-medium">{mergedData?.companyName || "N/A"}</div>
//                                   <div className="text-[10px] text-muted-foreground truncate">
//                                     {mergedData?.name || "No contact"}
//                                   </div>
//                                 </td>
//                                 <td className="py-1 px-2 border">
//                                   {mergedData?.email && <div className="truncate">{mergedData.email}</div>}
//                                   {mergedData?.contactNumbers && (
//                                     <div className="text-[10px] text-muted-foreground truncate">
//                                       {mergedData.contactNumbers.split(",")[0]}
//                                     </div>
...
//                                   <DropdownMenu>
//                                     <DropdownMenuTrigger asChild>
//                                       <Button variant="ghost" size="icon" className="h-6 w-6 text-[10px]">
//                                         <span className="sr-only">Open menu</span>
//                                         <MoreHorizontal className="h-3 w-3" />
//                                       </Button>
//                                     </DropdownMenuTrigger>
...
//           <DialogContent className="max-w-4xl h-[90vh] overflow-hidden flex flex-col">
//             <DialogHeader>
//               <DialogTitle>Business Card - {selectedViewForm.cardNo || "N/A"}</DialogTitle>
//             </DialogHeader>
//             <div className="flex-grow overflow-y-auto">
//               <Tabs defaultValue="merged" className="w-full">
//                 <TabsList className="grid w-full grid-cols-4 sticky top-0 bg-background z-10">
...
//                       </CardHeader>
//                       <CardContent>
//                         <ExtractedDataForm form={selectedViewForm} closeDialog={() => setOpenView(null)} />
//                       </CardContent>
//                     </Card>
//                   </TabsContent>
//                   <TabsContent value="form">
...
//                                 >
//                                   <img
//                                     src={selectedViewForm.cardFrontPhoto || "/placeholder.svg"}
//                                     alt="Card Front"
//                                     className="max-w-full max-h-96 object-contain rounded-md border hover:opacity-90 transition"
//                                   />
//                                 </button>
...
//                                 >
//                                   <img
//                                     src={selectedViewForm.cardBackPhoto || "/placeholder.svg"}
//                                     alt="Card Back"
//                                     className="max-w-full max-h-96 object-contain rounded-md border hover:opacity-90 transition"
//                                   />
//                                 </button>
...
//           <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
//             <DialogHeader>
//               <DialogTitle>Edit Form - {selectedEditForm.cardNo || "N/A"}</DialogTitle>
//             </DialogHeader>
//             <ExhibitionForm
//               initialData={{
//                 cardNo: selectedEditForm.cardNo || "",
//                 salesPerson: selectedEditForm.salesPerson || "",
//                 date: selectedEditForm.date ? new Date(selectedEditForm.date).toISOString().split("T")[0] : "",
//                 country: selectedEditForm.country || "",
//                 cardFrontPhoto: selectedEditForm.cardFrontPhoto || "",
//                 cardBackPhoto: selectedEditForm.cardBackPhoto || "",
//                 leadStatus: selectedEditForm.leadStatus || "",
...
//         label: 'Card Image',
//         width: 'w-24',
//         render: (form: FormData) => form.cardFrontPhoto ? (
//           <button onClick={() => setZoomedImage(form.cardFrontPhoto!)} className="group">
//             <img
//               src={form.cardFrontPhoto || "/placeholder.svg"}
//               alt="Card"
...
//         label: 'Date',
//         width: 'w-24',
//         render: (form: FormData) => form.date ? new Date(form.date).toLocaleDateString() : "N/A"
//       },
//       {
//         id: 'user',
//         label: 'User',
...
//         label: 'Person Name',
//         width: 'w-32',
//         render: (form: FormData) => form.mergedData?.name || form.additionalData?.contactPerson || "N/A"
//       },
//       {
//         id: 'company',
//         label: 'Company',
//         width: 'w-32',
//         render: (form: FormData) => form.mergedData?.companyName || form.additionalData?.company || "N/A"
//       },
//       {
//         id: 'city',
//         label: 'City',
//         width: 'w-24',
//         render: (form: FormData) => form.extractedData?.city || form.additionalData?.city || "N/A"
//       },
//       {
//         id: 'country',
//         label: 'Country',
//         width: 'w-24',
//         render: (form: FormData) => form.country || "N/A"
//       },
//       {
//         id: 'contactInfo',
//         label: 'Contact Info',
...
//         label: 'Meeting',
//         width: 'w-20',
//         render: (form: FormData) => form.meetingAfterExhibition ? "Yes" : "No"
//       },
//       {
//         id: 'formStatus',
//         label: 'Form Status',
...
//     const allAdditionalKeys = forms.flatMap(f => Object.keys(f.additionalData || {}))
...
//     const allExtractedKeys = forms.flatMap(f => Object.keys(f.extractedData || {}))
//     const uniqueExtracted = [...new Set(allExtractedKeys)].filter(key => !fixedColumns.some(c => c.id.includes(key))).slice(0, 10)
...
//         { wch: 25 }, { wch: 20 }, { wch: 25 }, { wch: 20 }, { wch: 12 },
//         { wch: 12 }, { wch: 12 }, { wch: 22 }, { wch: 12 }, { wch: 18 },
//         { wch: 12 }, { wch: 20 }, { wch: 30 }, { wch: 18 }, { wch: 18 },
...
//         "leadStatus", "dealStatus", "meetingAfterExhibition", "description", "extractionStatus"
//       ]
...
//           Object.entries(updatedData).filter(([key]) => !coreFields.includes(key))
//         ),
//       }
...
//                     <>
//                       <tr>
//                         <td colSpan={2} className="py-2 px-2 border bg-gray-50 font-medium text-sm">
//                           Custom Fields
//                         </td>
//                       </tr>
...
//                           if (!col) return null
//                           return (
//                             <th key={colId} className={`bg-gray-100 py-2 px-2 border ${col.width}`}>
//                               {col.label}
//                             </th>
//                           )
//                         })}
...
//                                 if (!col) return null
//                                 return (
//                                   <td key={colId} className={`py-1 px-2 border ${col.width}`}>
//                                     {col.render(form)}
//                                   </td>
//                                 )
//                               })}
...
//                       ) : (
//                         <tr>
//                           <td colSpan={displayColumns.length} className="py-4 text-center border">
//                             {isLoading ? "Loading..." : "No forms found"}
//                           </td>
//                         </tr>
//                       )}
...
//             <Button onClick={() => setShowManage(false)}>Close</Button>
//           </div>
//         </DialogContent>
//       </Dialog>
  ...
  const possibleColumns = useMemo(() => {
    const fixedColumns = [
      ...
      },
      {
        ...
        width: "w-24",
        render: (form: FormData) =>
          form.extractedData?.city || form.additionalData?.city || "N/A",
      },
      {
        id: "country",
        label: "Country",
