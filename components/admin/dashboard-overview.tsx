...
export function DashboardOverview({ forms }: DashboardOverviewProps) {
  ...
  const {
    ...
    const meetingsScheduled = forms.filter(
      (f) => f.meetingAfterExhibition
    ).length;
    const extractionSuccessRate = forms.filter(
      (f) => f.extractionStatus === "completed"
    ).length;

    const leadStatusChart = Object.entries(leadStatusData).map(
      ([name, value]) => ({
        name,
        value,
      })
    ...
    const dealStatusChart = Object.entries(dealStatusData).map(
      ([name, value]) => ({
        name,
        value,
      })
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="relative">
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex gap-3 px-4">
              {/* Total Card Scans */}
              <div className="flex-none w-[70vw] max-w-xs">
                <Card className="h-full border-l-4 border-l-blue-500 dark:border-l-blue-400 bg-white dark:bg-gray-800/90 shadow-lg">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-xs font-medium text-muted-foreground">
                        Total Scans
              ...
              {/* Active Users */}
              <div className="flex-none w-[70vw] max-w-xs">
                <Card className="h-full border-l-4 border-l-purple-500 dark:border-l-purple-400 bg-white dark:bg-gray-800/90 shadow-lg">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-xs font-medium text-muted-foreground">
                        Active Users
              ...
              {/* Meetings */}
              <div className="flex-none w-[70vw] max-w-xs">
                <Card className="h-full border-l-4 border-l-green-500 dark:border-l-green-400 bg-white dark:bg-gray-800/90 shadow-lg">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-xs font-medium text-muted-foreground">
                        Meetings
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {totalCards > 0
                        ? ((meetingsScheduled / totalCards) * 100).toFixed(0)
                        : 0}
                      % conv.
                    </p>
                  </CardContent>
              ...
              {/* Extraction */}
              <div className="flex-none w-[70vw] max-w-xs">
                <Card className="h-full border-l-4 border-l-orange-500 dark:border-l-orange-400 bg-white dark:bg-gray-800/90 shadow-lg">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-xs font-medium text-muted-foreground">
                        Extraction
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {totalCards > 0
                        ? ((extractionSuccessRate / totalCards) * 100).toFixed(
                            0
                          )
                        : 0}
                      % rate
          ...
          <button
            onClick={scrollPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full p-1.5 shadow-lg border border-gray-200 dark:border-gray-700"
          >
            <ChevronLeft className="w-5 h-5 text-gray-700 dark:text-gray-300" />
          </button>
          <button
            onClick={scrollNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full p-1.5 shadow-lg border border-gray-200 dark:border-gray-700"
          >
      ...
      {/* ==================== DESKTOP: 4-COLUMN GRID ==================== */}
      <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <Card className="border-l-4 border-l-blue-500 dark:border-l-blue-400 bg-white dark:bg-gray-800/90 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between pb-1.5">
            <CardTitle className="text-xs sm:text-sm font-medium text-muted-foreground">
              Total Card Scans
            </CardTitle>
            <FileText className="h-3 w-3 sm:h-4 sm:w-4 text-blue-500 dark:text-blue-400" />
          </CardHeader>
          <CardContent className="pt-1">
        ...
        <Card className="border-l-4 border-l-purple-500 dark:border-l-purple-400 bg-white dark:bg-gray-800/90 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between pb-1.5">
            <CardTitle className="text-xs sm:text-sm font-medium text-muted-foreground">
              Active Users
            </CardTitle>
            <Users className="h-3 w-3 sm:h-4 sm:w-4 text-purple-500 dark:text-purple-400" />
          </CardHeader>
          <CardContent className="pt-1">
            <div className="text-2xl sm:text-3xl font-bold text-foreground">
              {totalUsers}
        ...
        <Card className="border-l-4 border-l-green-500 dark:border-l-green-400 bg-white dark:bg-gray-800/90 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between pb-1.5">
            <CardTitle className="text-xs sm:text-sm font-medium text-muted-foreground">
              Meetings Scheduled
            </CardTitle>
          ...
          <CardContent className="pt-1">
            ...
            <p className="text-xs text-muted-foreground">
              {totalCards > 0
                ? ((meetingsScheduled / totalCards) * 100).toFixed(1)
                : 0}
              % conv.
            </p>
          </CardContent>
        ...
        <Card className="border-l-4 border-l-orange-500 dark:border-l-orange-400 bg-white dark:bg-gray-800/90 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between pb-1.5">
            <CardTitle className="text-xs sm:text-sm font-medium text-muted-foreground">
              Extraction Success
            </CardTitle>
          ...
          <CardContent className="pt-1">
            ...
            <p className="text-xs text-muted-foreground">
              {totalCards > 0
                ? ((extractionSuccessRate / totalCards) * 100).toFixed(1)
                : 0}
              % rate
            </p>
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="bg-white dark:bg-gray-800/90 shadow-lg">
          ...
          <CardContent>
            <Suspense
              fallback={
                <div className="h-56 w-full animate-pulse bg-muted/30 rounded-lg" />
              }
            >
              <ResponsiveContainer
                width="100%"
        ...
        {/* USER PERFORMANCE – EXCEL TABLE */}
        <Card className="md:col-span-2 bg-white dark:bg-gray-800/90 shadow-lg">
          <CardHeader>
            <CardTitle className="text-sm sm:text-base flex flex-col sm:flex-row sm:items-center gap-1">
              User Performance
              <span className="text-xs font-normal text-muted-foreground">
          ...
          <CardContent>
            <Suspense
              fallback={
                <div className="h-64 w-full animate-pulse bg-muted/30 rounded-lg" />
              }
            >
              <ResponsiveContainer
                width="100%"
            ...
            {/* EXCEL TABLE */}
            {userChartData.length > 0 && (
              <div className="-mx-4 overflow-x-auto mt-6">
                <div className="inline-block min-w-full align-middle">
                  <table className="w-full text-xs border border-gray-300 dark:border-gray-700">
                    <thead className="bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700">
                      <tr>
                        <th className="sticky left-0 bg-gray-100 dark:bg-gray-800 px-4 py-2 text-left font-semibold text-gray-700 dark:text-gray-300 border-r border-gray-300 dark:border-gray-700">
                          Rank
                        </th>
                        <th className="px-4 py-2 text-left font-semibold text-gray-700 dark:text-gray-300 border-r border-gray-300 dark:border-gray-700">
                          User
                        </th>
                        <th className="px-4 py-2 text-center font-semibold text-gray-700 dark:text-gray-300 border-r border-gray-300 dark:border-gray-700">
                          Scans
                        </th>
                        <th className="px-4 py-2 text-center font-semibold text-red-600 dark:text-red-400 border-r border-gray-300 dark:border-gray-700">
                          Hot
                        </th>
                        <th className="px-4 py-2 text-center font-semibold text-green-600 dark:text-green-400 border-r border-gray-300 dark:border-gray-700">
                          Meetings
                        </th>
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {userChartData.map((u: any, i: number) => (
                        ...
                        >
                          <td className="sticky left-0 bg-white dark:bg-gray-800 px-4 py-2 font-medium border-r border-gray-300 dark:border-gray-700">
                            {i === 0
                              ? "1st"
                              : i === 1
                              ? "2nd"
                          ...
                          <td className="px-4 py-2 truncate max-w-[150px] sm:max-w-none border-r border-gray-300 dark:border-gray-700 text-foreground">
                            {u.fullName}
                          </td>
                          <td className="px-4 py-2 text-center font-bold border-r border-gray-300 dark:border-gray-700 text-foreground">
                            {u.scans}
                          </td>
                          <td className="px-4 py-2 text-center font-medium text-red-600 dark:text-red-400 border-r border-gray-300 dark:border-gray-700">
                            {u.hot}
                          </td>
                          <td className="px-4 py-2 text-center font-medium text-green-600 dark:text-green-400 border-r border-gray-300 dark:border-gray-700">
                            {u.meetings}
                          </td>
                          <td className="px-4 py-2 text-center font-medium text-blue-600 dark:text-blue-400">
                            {u.deals}
                          </td>
                        </tr>
                      ))}
