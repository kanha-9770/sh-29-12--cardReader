        ...
        <CardContent className="p-8 pt-4">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="Enter your password"
                  disabled={isSubmitting}
                  className="w-full pr-10 p-3 border border-gray-200 rounded-md bg-gray-50 text-gray-800 focus:ring-1 focus:ring-[#483d73] focus:border-[#483d73]"
                />

                <button
                  type="button"
                  aria-label={showPassword ? "Hide password" : "Show password"}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#483d73]"
            ...
            <div className="flex items-center justify-between text-sm text-gray-600">
              ...
              <Link
                href="/forgot-password"
                className="text-[#483d73] hover:text-[#2b2447]"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full py-2.5 bg-[#483d73] text-white rounded-md hover:bg-[#2b2447]"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
                <span className="flex items-center justify-center">
            ...
            <div className="text-center text-sm text-gray-600">
              Don’t have an account?{" "}
              <Link href="/signup" className="text-[#483d73] hover:text-[#2b2447]">
                Sign up
              </Link>
            </div>
