...
//     isAnnual ? Math.floor(plan.annualPriceINR / 12) : plan.monthlyPriceINR;
//   const getAnnualTotal = (plan: (typeof plans)[0]) => plan.annualPriceINR;
...
//           <h1 className="text-3xl md:text-5xl font-bold text-[#2d2a4a] mb-6">
//             Simple, Transparent Pricing
//           </h1>
//           <p className="text-sm sm:text-base lg:text-lg text-[#5a5570] max-w-2xl mx-auto mb-8 px-3">
...
//                     <div
//                       key={index}
//                       className="flex-none w-[calc(120vw-4.5rem)] snap-start max-w-[500px] px-5"
//                     >
//                       <Card
//                         className={`relative h-full min-h-[470px] flex flex-col border border-gray-200 shadow-sm transition-all duration-200 rounded-xl ${
//                           plan.popular
//                             ? "bg-[#f3f1f8] ring-2 ring-[#483d73]"
//                             : "bg-white"
//                         }`}
//                       >
//                         {plan.popular && (
//                           <div className="absolute -top-2 left-1/2 -translate-x-1/2 z-10">
//                             <div className="bg-[#483d73] text-white px-3 py-1 rounded-full text-[10px] flex items-center gap-1 shadow-sm">
//                               <Star className="h-3 w-3" /> Most Popular
//                             </div>
//                           </div>
//                         )}
//                         <CardHeader className="text-center pb-5 pt-6 flex-shrink-0">
//                           <div className="h-10 w-10 rounded-full bg-[#e5e2f0] flex items-center justify-center mx-auto mb-3">
//                             <plan.icon className="h-5 w-5 text-[#483d73]" />
//                           </div>
//                           <CardTitle className="text-lg font-bold text-[#2d2a4a] mb-1">
//                             {plan.name}
//                           </CardTitle>
//                           <p className="text-[11px] leading-tight text-[#5a5570]">
//                             {plan.description}
//                           </p>
//                           <div className="mt-2">
//                             <span className="text-2xl font-bold text-[#2d2a4a]">
//                               ₹{getPrice(plan)}
//                             </span>
//                             <span className="text-[#5a5570] text-xs">/month</span>
//                             {isAnnual && (
//                               <p className="text-[10px] text-[#5a5570] mt-1">
...
//                             {(isExpanded ? plan.features : plan.features.slice(0, 5)).map(
//                               (f, i) => (
//                                 <li
//                                   key={i}
//                                   className="flex items-start justify-center gap-2 text-[11px] text-[#2d2a4a]"
//                                 >
//                                   <Check className="h-4 w-4 text-[#483d73] mt-0.5 flex-shrink-0" />
//                                   <span>{f}</span>
//                                 </li>
//                               )
//                             )}
//                             {plan.features.length > 5 && (
//                               <li className="text-[10px] italic text-[#5a5570]">
//                                 <span
...
//                             disabled={loadingPlan === plan.name}
//                             onClick={() =>
//                               handleCheckout(plan.name, getPrice(plan))
//                             }
//                             className={`w-full py-2 text-xs rounded-lg transition-all ${
//                               plan.popular
//                                 ? "bg-[#483d73] hover:bg-[#5a5570] text-white"
//                                 : "border border-[#483d73] text-[#483d73] hover:bg-[#f3f1f8]"
//                             }`}
//                             variant={plan.popular ? "default" : "outline"}
//                           >
//                             {loadingPlan === plan.name
...
//             <button
//               onClick={scrollPrev}
//               className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/95 p-2 rounded-full shadow-md z-20 active:scale-95"
//             >
//               <ChevronLeft className="w-4 h-4 text-[#483d73]" />
//             </button>
//             <button
//               onClick={scrollNext}
//               className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/95 p-2 rounded-full shadow-md z-20 active:scale-95"
//             >
//               <ChevronRight className="w-4 h-4 text-[#483d73]" />
//             </button>
//           </div>
//         </section>
//         {/* DESKTOP REMAINS SAME */}
//         <section className="py-12 bg-white hidden md:block fade-in-up">
//           <div className="container mx-auto px-4">
//             <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
//               {plans.map((plan, index) => (
//                 <Card
...
//                       <div className="bg-[#483d73] text-white px-4 py-1 rounded-full text-sm flex items-center gap-1">
...
//                           <Check className="h-5 w-5 text-[#483d73] mt-0.5 flex-shrink-0" />
//                           <span className="text-sm text-[#2d2a4a]">{f}</span>
//                         </li>
//                       ))}
//                     </ul>
//                     <Button
...
//         {/* Comparison Table */}
//         <section
//           className="py-10 bg-[#f3f1f8] fade-in-up"
...
//                 Compare Plans
//               </h2>
//               <p className="text-[#5a5570] text-sm sm:text-base lg:text-lg">
//                 See what's included in each plan to find the perfect fit for
//                 your needs
//               </p>
//             </div>
//             <div className="max-w-4xl mx-auto">
...
//                     <thead>
//                       <tr className="border-b border-[#e5e2f0]">
//                         <th className="text-left p-3 sm:p-4 md:p-6 text-[#2d2a4a] font-semibold">
//                           Features
//                         </th>
//                         <th className="text-center p-3 sm:p-4 md:p-6 text-[#2d2a4a] font-semibold">
//                           Starter
//                         </th>
//                         <th className="text-center p-3 sm:p-4 md:p-6 text-[#2d2a4a] font-semibold">
//                           Professional
...
//                           style={{ animationDelay: `${(index + 1) * 0.1}s` }}
//                         >
//                           <td className="p-3 sm:p-4 md:p-6 text-[#2d2a4a] font-medium">
//                             {row.feature}
//                           </td>
//                           <td className="p-3 sm:p-4 md:p-6 text-center text-[#5a5570]">
//                             {row.starter}
//                           </td>
//                           <td className="p-3 sm:p-4 md:p-6 text-center text-[#5a5570]">
//                             {row.pro}
...
//         {/* CTA */}
//         <section
//           className="py-10 bg-[#e5e2f0] fade-in-up"
...
//                     Ready to Transform Your Networking?
//                   </h2>
//                   <p className="text-[#5a5570] mb-5 text-sm sm:text-base lg:text-lg">
//                     Start your free trial today and see why thousands of
//                     professionals trust CardSync.
//                   </p>
//                   <div className="flex flex-row items-center gap-3 max-w-full">
//                     <Link href="/form" className="flex-shrink">
//                       <Button
//                         size="lg"
//                         className="bg-[#483d73] hover:bg-[#5a5570] text-white transition-all duration-300 hover:scale-105 px-3 py-1 text-sm sm:px-5 sm:py-2 sm:text-base"
//                       >
//                         Start Free Trial
//                       </Button>
//                     </Link>
...
//                       size="lg"
//                       variant="outline"
//                       className="border-[#483d73] text-[#483d73] hover:bg-[#f3f1f8] transition-all duration-300 hover:scale-105 px-3 py-1 text-sm sm:px-5 sm:py-2 sm:text-base"
//                     >
//                       Schedule Demo
//                     </Button>
//                   </div>
...
//                                 <li
//                                   key={i}
//                                   className="flex items-center justify-center gap-2 text-[11px] text-[#2d2a4a]"
//                                 >
//                                   <Check className="h-4 w-4 text-[#483d73] flex-shrink-0" />
//                                   <span>{f}</span>
//                                 </li>
//                               )
//                             )}
...
//                     >
//                       <Card
//                         className={`relative h-full min-h-[470px] flex flex-col border transition-all duration-200 rounded-xl ${
//                           plan.popular
//                             ? "bg-[#f3f1f8] ring-2 ring-[#483d73]"
//                             : plan.isFree
//                             ? "border-gray-300 bg-gradient-to-br from-[#f9f8fb] to-white shadow-md"
...
//                                 ₹{getPrice(plan)}
//                               </span>
//                               <span className="text-[#5a5570] text-xs">
//                                 /month
//                               </span>
//                               {isAnnual && (
//                                 <p className="text-[10px] text-[#5a5570] mt-1">
...
//                           ) : (
//                             <div className="mt-4">
//                               <span className="text-3xl font-bold text-[#2d2a4a]">
//                                 {plan.price}
//                               </span>
//                             </div>
//                           )}
...
//                           ) : (
//                             <Button
//                               className="w-full bg-[#483d73] text-white opacity-70 cursor-not-allowed"
//                               disabled
//                             >
//                               {plan.cta}
//                             </Button>
...
//                       ? "bg-[#f3f1f8] ring-2 ring-[#483d73] scale-105"
//                       : plan.isFree
//                       ? "bg-gradient-to-br from-[#f9f8fb] to-white border border-gray-300"
//                       : "bg-white hover:scale-105"
//                   }`}
//                   style={{ animationDelay: `${index * 0.2}s` }}
//                 >
...
//                   <CardHeader class30 className="text-center pb-6">
//                     <div className="h-12 w-12 rounded-full bg-[#e5e2f0] flex items-center justify-center mx-auto mb-4">
//                       <plan.icon className="h-6 w-6 text-[#483d73]" />
//                     </div>
//                     <CardTitle className="text-2xl font-bold text-[#2d2a4a] mb-2">
      ...
      <div className="min-h-screen bg-[#f3f1f8] dark:bg-gray-900">
        ...
        <section className="py-10 bg-white dark:bg-gray-800 block md:hidden">
          <div className="relative w-full">
                ...
                {plans.map((plan, index) => {
                  ...
                  return (
                    <div key={index} className="flex-none w-[calc(120vw-4.5rem)] snap-start max-w-[500px] px-5">
                      <Card className={`relative h-full min-h-[470px] flex flex-col border transition-all duration-200 rounded-xl ${
                        plan.popular
                          ? "bg-[#aca8b6] ring-2 ring-[#483d73]"
                          : plan.isFree
                          ? "border-gray-300 bg-gradient-to-br from-[#f9f8fb] to-white shadow-md"
                        ...
                        <CardHeader className="text-center pb-5 pt-6 flex-shrink-0">
                          <div className="h-10 w-10 rounded-full bg-[#e5e2f0] dark:bg-gray-700 flex items-center justify-center mx-auto mb-3">
                            <plan.icon className="h-5 w-5 text-[#483d73]" />
                          </div>
                          ...
                          <ul className="space-y-2 flex-1 text-center">
                            ...
                            {plan.features.length > 5 && (
                              <li className="text-[10px] italic text-[#5a5570] dark:text-gray-500">
                                <span className="cursor-pointer underline" onClick={() => toggleFeatures(plan.name)}>
                                  {isExpanded ? "Show less" : `+${plan.features.length - 5} more`}
                                </span>
                              </li>
                            )}
                          ...
                          {!plan.isFree ? (
                            <Button
                              ...
                              className={`w-full py-2 text-xs rounded-lg transition-all ${
                                plan.popular
                                  ? "bg-[#483d73] hover:bg-[#5a5570] text-white"
                                  : "border border-[#483d73] text-[#483d73] hover:bg-[#f3f1f8] dark:hover:bg-gray-700"
                              }`}
                              variant={plan.popular ? "default" : "outline"}
                            >
                            ...
                            <Button className="w-full bg-[#483d73] text-white opacity-70 cursor-not-allowed" disabled>
                              {plan.cta}
                            </Button>
                          )}
                        </CardContent>
            ...
            <button onClick={scrollPrev} className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/95 dark:bg-gray-800/95 p-2 rounded-full shadow-md z-20 active:scale-95">
              <ChevronLeft className="w-4 h-4 text-[#483d73]" />
            </button>
            <button onClick={scrollNext} className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/95 dark:bg-gray-800/95 p-2 rounded-full shadow-md z-20 active:scale-95">
              <ChevronRight className="w-4 h-4 text-[#483d73]" />
            </button>
          </div>
        </section>
        ...
        <section className="py-12 bg-white dark:bg-gray-800 hidden md:block fade-in-up">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
              {plans.map((plan, index) => (
                <Card key={index} className={`relative border-none shadow-lg transition-all hover:shadow-xl fade-in-up ${
                  plan.popular
                    ? "bg-[#f3f1f8] ring-2 ring-[#483d73] scale-105"
                    : plan.isFree
                    ? "bg-gradient-to-br from-[#f9f8fb] to-white border border-gray-300"
                  ...
                  <CardHeader className="text-center pb-6">
                    <div className="h-12 w-12 rounded-full bg-[#e5e2f0] dark:bg-gray-700 flex items-center justify-center mx-auto mb-4">
                      <plan.icon className="h-6 w-6 text-[#483d73]" />
                    </div>
                    <CardTitle className="text-2xl font-bold text-[#2d2a4a] dark:text-white mb-2">
                      {plan.name}
                    </CardTitle>
                    <p className="text-[#5a5570] dark:text-gray-400 mb-4">{plan.description}</p>
                    ...
                    {!plan.isFree ? (
                      <div className="text-center">
                        ...
                        <span className="text-[#5a5570] dark:text-gray-400">/month</span>
                        {isAnnual && (
                  ...
                  <CardContent className="space-y-6">
                    <ul className="space-y-3">
                      {plan.features.map((f, i) => (
                        <li key={i} className="flex items-start gap-3">
                          <Check className="h-5 w-5 text-[#483d73] mt-0.5 flex-shrink-0" />
                          <span className="text-sm text-[#2d2a4a] dark:text-gray-300">{f}</span>
                        </li>
                      ))}
                    </ul>
