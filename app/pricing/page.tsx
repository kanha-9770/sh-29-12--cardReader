    ...
    <>
      ...
      <div className="min-h-screen bg-[#f3f1f8]">
        ...
        <section className="py-10 text-center fade-in-up">
          ...
          <p className="text-lg text-[#5a5570] max-w-2xl mx-auto mb-8 px-3">
            Choose the perfect plan. 30-day free trial. No credit card required.
          </p>
            ...
            >
              <div className="flex gap-5 px-5 py-2">
                {plans.map((plan, index) => (
                  <div
                    key={index}
                    className="flex-none w-[78vw] snap-start max-w-[300px]"
                  >
                    <Card
                    ...
                    >
                      ...
                      <CardContent className="flex flex-col justify-between space-y-3 px-4 pb-4">
                        <ul className="space-y-2 flex-1">
                          {plan.features.slice(0, 5).map((f, i) => (
                            <li
                              key={i}
                              className="flex items-start gap-2 text-[11px] text-[#2d2a4a]"
                            >
        ...
        {/* Comparison Table */}
        <section
          className="py-16 bg-[#f3f1f8] fade-in-up"
        ...
        {/* CTA */}
        <section
          className="py-16 bg-[#e5e2f0] fade-in-up"
