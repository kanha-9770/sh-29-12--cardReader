...
export default function Home() {
  return (
    <div className=" bg-[#f3f1f8] pt-12">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              <div className="inline-flex items-center gap-2 bg-[#e5e2f0] px-4 py-2 rounded-full text-sm text-[#2d2a4a]">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-md bg-[#f3f1f8] hover:shadow-lg transition-shadow">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#e5e2f0]">
        <div className="container mx-auto px-4">
