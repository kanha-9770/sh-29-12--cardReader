  ...
  return (
    <>
      ...
      <div className="bg-[#f3f1f8]">
        ...
        {/* How It Works */}
        <section className="py-6 md:py-10 bg-white fade-in-up">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-5 md:mb-10">
              <h2 className="text-2xl md:text-4xl font-bold text-[#2d2a4a] mb-2 md:mb-4">
                How CardSync Works
              </h2>
              <p className="text-[#5a5570] text-sm md:text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 max-w-5xl mx-auto">
              {[1, 2, 3].map((step, i) => (
                <div
                  key={i}
                  className="text-center space-y-2 md:space-y-4 fade-in-up"
                >
                  <div className="h-10 md:h-16 w-10 md:w-16 rounded-full bg-[#e5e2f0] flex items-center justify-center mx-auto mb-3 md:mb-6">
                    <span className="text-xl font-bold text-[#483d73]">
                      {step}
                    </span>
                  </div>
                  <h3 className="text-lg md:text-xl font-semibold text-[#2d2a4a]">
                    {step === 1 && "Scan the Card"}
                    {step === 2 && "Process Information"}
                    {step === 3 && "Sync & Manage"}
                  </h3>
                  <p className="text-[#5a5570] text-sm md:text-base">
                    {step === 1 && "Capture using device or mobile."}
                    {step === 2 && "AI extracts contact data."}
